...
#Updated 30/10/13 to include prior adjustment factors - Conrad MacCormick
...
series{
  ...
  period=4
  title='mnlf'
  file='/nas/corporate/snzdata/prd/seasadj/hlfs/d/mnlf.dat'
  save=(b1)
  format=datevalue
}
...
transform{
  type=permanent
  file='/nas/corporate/snzdata/prd/seasadj/hlfs/f/mnlf.fac'
  mode=ratio
  function=log
  format=datevalue
}
