...
**Note: Empty lines in an MTA file do not mean anything to the X13 program.  They are a Statistics NZ convention and they do mean something to the sadj package - The groupings are run as submitted as their own batches to X13.**
